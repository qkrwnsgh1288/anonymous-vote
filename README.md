...
However, *if blockchain is used, electronic voting system is possible **based on trust** rather than assuming trust.* And here, my voting information('yes' or 'no') is not exposed on the public bulletin board, so <b>secret ballot</b> is possible.<br>
