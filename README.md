...
However, <u>if blockchain is used, electronic voting system is possible <b>based on trust</b> rather than assuming trust.</u> And here, my voting information is not exposed on the public bulletin board, so <b>secret ballot</b> is possible.<br>
