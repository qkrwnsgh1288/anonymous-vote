...
var (
	...
	DefaultCLIHome = os.ExpandEnv("$HOME/go/projects/.votecli")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/go/projects/.voted")
...
func NewNameServiceApp(
	...
	keys := sdk.NewKVStoreKeys(bam.MainStoreKey, auth.StoreKey, staking.StoreKey,
		supply.StoreKey, distr.StoreKey, slashing.StoreKey, params.StoreKey, voteservice.StoreKey)
	...
	app.mm = module.NewManager(
		...
		voteservice.NewAppModule(app.nsKeeper, app.bankKeeper),
